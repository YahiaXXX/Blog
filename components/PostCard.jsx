...
function PostCard({post}) {
  ...
  return (
    <div className=' bg-white shadow-lg rounded-lg p-0 lg:p-8 pb-12 mb-8' >
      ...
      <p className=' text-center text-lg text-gray-700 font-normal px-4 lg:p-12 mb-8' >{post.excerpt}</p>
      <div className=' text-center' >
        <Link href={`/post/${post.slug}`} >
          <span className=' transition duration-500 transform hover:-translate-y-1 inline-block bg-pink-600 text-lg font-medium rounded-full text-white cursor-pointer px-8 py-3' >Continue reading</span>
        </Link>
